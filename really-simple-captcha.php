	...
	public function generate_image( $prefix, $word ) {		
		...
		if ( $im = imagecreatetruecolor( $this->img_size[0], $this->img_size[1] ) ) {
			...
			for ( $i = 0; $i < strlen( $word ); $i++ ) {
				...
				$text = imagettftext( $im, $this->font_size, mt_rand( -12, 12 ), $x,
		...
		*/
		...
		$im = imagecreatetruecolor(90, $this->img_size[1]);
		...
		$folder = $upload_dir['basedir'].'/captcha/';
		//var_dump($upload_dir,$folder);
		$filename = $prefix.$this->generate_random_word().".jpg";
		$file =  $folder. $filename ;
		Imagejpeg($im, $file,100);		
		imagedestroy($im);

		$url_file = $upload_dir['baseurl'].'/capcha/'.$filename;
